...
namespace WindowsInput
{
    ...
    internal class InputBuilder : IEnumerable<INPUT>
    {
                                    ...
                                    new KEYBDINPUT
                                        {
                                            ...
                                            Flags = (UInt32) (KeyboardFlag.ScanCode | (IsExtendedKey(keyCode) ? KeyboardFlag.ExtendedKey : 0)),
                                            Time = 0,
                                    ...
                                    new KEYBDINPUT
                                        {
                                            KeyCode = (UInt16) keyCode,
                                            Scan = (UInt16)(NativeMethods.MapVirtualKey((UInt32)keyCode, 0) & 0xFFU),
                                            Flags = (UInt32) (KeyboardFlag.ScanCode | (IsExtendedKey(keyCode)
        ...
        public static double getAbsoluteScreenCoord(double resolution, double pos)
        {
            // Absolute position goes from 0 -> 65536.0f that's why we do this
            return pos * (65536.0d / resolution);
        }
        ...
        static int screenResolutionHeight = GetSystemMetrics(SystemMetric.SM_CYSCREEN);
        static int screenResolutionWidth = GetSystemMetrics(SystemMetric.SM_CXSCREEN);
        /// <summary>
        ...
        /// <returns>This <see cref="InputBuilder"/> instance.</returns>
        public InputBuilder AddAbsoluteMouseMovement(double x, double y)
        {
            var movement = new INPUT { Type = (uint)InputType.Mouse };

            movement.Data.Mouse.X = (int)(0.5d + getAbsoluteScreenCoord(screenResolutionWidth, x));
            movement.Data.Mouse.Y = (int)(0.5d + getAbsoluteScreenCoord(screenResolutionHeight, y));

            movement.Data.Mouse.Flags = (uint)(MouseFlag.Move | MouseFlag.Absolute);
            movement.Data.Mouse.Time = 0;
